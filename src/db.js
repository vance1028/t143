...
async function resetAll() {
  ...
  try {
    ...
    for (const t of ['billing_snapshots', 'lot_rate_bindings', 'rate_segments', 'rate_plans', 'holiday_calendar', 'parking_sessions', 'parking_spaces', 'vehicles', 'parking_lots', 'users']) {
